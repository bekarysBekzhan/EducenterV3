...
const CourseRow = ({
    ...
    return (
        <TouchableOpacity
            ...
            <ItemRating rating={rating} reviewCount={reviewCount} starSize={16} word={false} />
        </TouchableOpacity>
    );
};
...
const styles = StyleSheet.create({
    ...
    categoryName: {
        ...setFontStyle(11, '400', APP_COLORS.primary),
        letterSpacing: 0.4,
        textAlign: 'left',
    },
    title: {
        ...setFontStyle(13, '600', APP_COLORS.font),
        letterSpacing: 0.4,
        textAlign: 'left',
        marginVertical: 4, 
    },
    textPrice: {
        ...setFontStyle(14, '700', APP_COLORS.darkblack),
        textAlign: 'left',
    },
    textOldPrice: {
        ...setFontStyle(10, '400', APP_COLORS.label),
        textAlign: 'left',
    },
    column: {
